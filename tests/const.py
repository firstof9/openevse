...
DIAG_DEVICE_RESULTS = {
    ...
    "using_ethernet": False,
    "vehicle": True,
    "vehicle_eta": datetime.datetime(2026, 1, 9, 17, 0, tzinfo=datetime.UTC),
    "vehicle_range": 468,
    "vehicle_soc": 75,
